...
ชุดคำถามที่ใช้ในการวัดผลมีจำนวน **180 ข้อ ครอบคลุมทั้ง DSBA, IT, AIT และ BIT (หลักสูตรละ 45 ข้อ)** ประกอบด้วยคำถามระดับง่าย กลาง ยาก และคำถามเชิงปฏิเสธ (Negative Testing)

### สรุปผลการทดสอบ (Benchmark Results)

| รายการประเมิน | จำนวนข้อ | ผ่าน | อัตราความสำเร็จ |
|:---|:---:|:---:|:---:|
| หลักสูตร DSBA (ข้อเท็จจริง แผนการเรียน และ Prerequisite) | 45 | 45 | 100% |
| หลักสูตร IT (ข้อเท็จจริง แผนการเรียน และ Prerequisite) | 45 | 45 | 100% |
| หลักสูตร AIT (ข้อเท็จจริง แผนการเรียน และ Prerequisite) | 45 | 45 | 100% |
| หลักสูตร BIT (ข้อเท็จจริง แผนการเรียน และ Prerequisite) | 45 | 45 | 100% |
| **ภาพรวมการสร้าง SQL (SQL Execution Rate)** | **180** | **180** | **100%** |
| **ภาพรวมความถูกต้องของคำตอบ (Answer Accuracy)** | **180** | **180** | **100%** |
